# Superseded benchmark snapshots — through 2026-09-10

These sections were the current snapshot in
[`../../reference/benchmark-current.md`](../../reference/benchmark-current.md)
until the 2026-09-24 remeasurement after the simplification sprint replaced
them. They are kept verbatim as historical evidence. The code they measured no
longer exists in this form: the network section predates one fetch engine and
self-contained packs, and the clone-storage section predates the per-OID tree
projection, deleted repack, and deflated loose objects. Relative links inside
the moved text were adjusted to this folder.
