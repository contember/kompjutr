...
How docs work in **kompjutr**. This file is self-contained: read it and you
...
The root `CLAUDE.md` holds the binding implementation invariants. `README.md`
is the public product overview; when it drifts, update it from current reference.
...
- Only `INDEX.md` and this `CLAUDE.md` live in `docs/` root — everything else in
  a subfolder.
