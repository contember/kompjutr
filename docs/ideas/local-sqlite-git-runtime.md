...
- Git core consumes the structural [`Worktree`](../../src/core/worktree.ts)
  interface and has no Durable Object dependency.
- [`SqliteGitDatabase`](../../src/sqlite/store.ts) consumes `SqlDatabase`, not
