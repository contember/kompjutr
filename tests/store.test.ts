...
describe("repository registry", () => {
  ...
  it("creates no .git rows of any kind", () => {
    ...
    expect(tables.map((t) => t.name)).toEqual([
      ...
      "git_index_dirty",
      "git_index_state",
      "git_integration_object_chunks",
      "git_integration_objects",
      "git_integration_plan_entries",
      ...
      "git_pack_graph_affected",
      "git_pack_graph_memo",
      "git_pack_graph_operations",
      "git_pack_graph_path",
      "git_pack_ingest_control",
      "git_pack_meta",
      "git_pack_objects",
      "git_pack_pending",
      "git_pack_read_frontier",
      "git_pack_read_pages",
      "git_pack_read_scopes",
      "git_promised_blobs",
