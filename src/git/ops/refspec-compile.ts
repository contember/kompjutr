...
import {
  checkRefText,
  hasCanonicalRefPatternSyntax,
  hasCanonicalRefSyntax,
} from "../common/ref-name.js";
...
import { canonicalRefText, invalidRef, malformed, requireFullRef } from "./refspec-validation.js";
