...
import { writeOperationJournalOwned } from "../store/operation-journal.js";
import { writeUnpublishedCommit } from "./commit.js";
...
import type { RebaseStateMetadata } from "./operation-state.js";
import {
  advance,
  hardMaterializeTree,
  initialState,
