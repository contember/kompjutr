...
import { readRef } from "../../ops/repository/plumbing.js";
import { type CommitView, linearLogRange, log, show } from "../../ops/repository/reads.js";
import { lsFilesWithWorktree } from "../../ops/staging/staging.js";
import { eagerStatus, statusBranch } from "../../ops/status/status.js";
import {
  formatCliPathLines,
  formatCliStatus,
  statusFormatOptions,
} from "../../ops/status/status-format.js";
import type { StatusDetail } from "../../ops/status/status-rows.js";
import {
